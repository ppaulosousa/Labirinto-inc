class Character {
    ...
    constructor(args) {
        ...
        this.mesh.position.set(900, 54, 900); //Posição do personagem
    ...
    move() {
        ...
        this.mesh.position.x += this.direction.x * ((this.direction.z === 0) ? 12 :
            Math.sqrt(24));
        this.mesh.position.z += this.direction.z * ((this.direction.x === 0) ? 12 :
            Math.sqrt(24));
