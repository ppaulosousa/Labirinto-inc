class World {
    ...
    new THREE.CubeGeometry(1600, 200, 64), //parede prin   3
    ...
    new THREE.CubeGeometry(250, 200, 100), //48
    ...
    this.obstacles[3].position.set(-1000, 100, 200); 
...
//baixo finish
    ...
    this.obstacles[48].position.set(-1000, 100, -890); 
    this.obstacles[48].rotation.y = Math.PI / 2;
